...
public class Client {
    ...
    public static void main(String args[]) {
        ...
        while (clientTrialNumber <= 10) {
            ...
            if (mesgSentToServer.equals("fail")) {
                System.out.print("\nCan't find password.");
                if (clientTrialNumber != 10)
                    System.out.print(" request for another packet...");
    ...
    /**
     * this method is for comparing given hash from server with generating password
     * hash.
     */
